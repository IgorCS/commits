...
var urlArray1= urlString.split("http://localhost:8080/ocorrencia-cpi/lista_Ocorrencia?pager.offset=");
...
<h1>Utilização da função <b>replaceAll</b> - Solução Elegante:</h1>
<script language="JavaScript">
var txt = window.location;
var urlString = txt.toString();
document.write ('<br />De: <b>' + urlString + '</b>');
// UTILIZANDO A FUNÇÃO RELACE
ts = urlString.replaceAll("http://localhost:8080/ocorrencia-cpi/lista_Ocorrencia?pager.offset=","");
//int myIntResult = int.ParseInt(ts);
parseInt(ts);
document.write ('<br />Para: <b>' + ts + '</b>');	
...
#pagination {
	...
	<ul id="navigation">
		...
		<li><span class="active"><a href="novaTarefa">Nova Ocorrencia</a></span></li>
...
<%
String text = pageUrl;  
text  = pageUrl.replaceAll("[-ocorrencia-cpi/WEB-INF/views/tarefa/listar_ocurrence.jsp?pager.offset=]", ""); 
Integer numero = Integer.parseInt(text);
%>
        <a href="lista_Ocorrencia?pager.offset=<%=numero%>" class="active curved">[Primeira]</a>
        </pg:first>  
...
Integer numero = Integer.parseInt(text);
%>
        <a href="lista_Ocorrencia?pager.offset=<%=numero%>" class="active curved">[Anterior]</a>  
    </pg:prev>   
...
<!--  for (int cont = 15; cont <= 15; cont++)>-->
     ...
     <td><a href="lista_Ocorrencia?pager.offset=<%=numero%>" class="active" />
...
Integer numero = Integer.parseInt(text);
%>
    <a href="lista_Ocorrencia?pager.offset=<%=numero%>" class="active curved"/>Proxima: <%=numero%></a>  
    </pg:next> 
...
Integer numero = Integer.parseInt(text);
%>
        <a href="lista_Ocorrencia?pager.offset=<%=numero%>" class="active curved">[Ultima]</a>  
    </pg:last>   

...
<h1>
	Utilização da função <b>replaceAll</b> - Solução Elegante:
</h1>
<script language="JavaScript">
...
ts = urlString.replaceAll("http://localhost:8080/ocorrencia-cpi/listaTarefas?pager.offset=","");
	...
	<div id="content" class="container_16 clearfix">
		...
		<table class="mytab">
			<thead>
				...
				<pg:pager maxPageItems="15" maxIndexPages="7"
		...
		<pg:index>
			...
			<pg:first>
				<%
					String text = pageUrl;
								text = pageUrl
										.replaceAll(
												"[-ocorrencia-cpi/WEB-INF/views/tarefa/lista.jsp?pager.offset=]",
												"");
								Integer numero = Integer.parseInt(text);
				%>
				<a href="listaTarefas?pager.offset=<%=numero%>"
					class="active curved">[Primeira]</a>
			</pg:first>
			...
			<pg:prev>
				...
				%>
				<a href="listaTarefas?pager.offset=<%=numero%>"
					class="active curved">[Anterior]</a>
			</pg:prev>
        ...
        <a href='<c:out value="${pageNumber}"/>'></a>  
			...
			<pg:pages>
				...
				<td><a href="listaTarefas?pager.offset=<%=numero%>"
					class="active" /> <c:out value="${pageNumber}" /></a>
			</pg:pages>
			<pg:next>
				<%
					String text = pageUrl;
				...
				%>
				<a href="listaTarefas?pager.offset=<%=numero%>"
					class="active curved" />Proxima: <%=numero%></a>
			</pg:next>
